...
/**
 * An implementation of {@link Connection} that provides functionality to modify the behavior
 * dynamically.
 */
public class TestConnection implements Connection {
  ...
  public TestConnection(LeaksTrackingByteBufAllocator allocator) {
  ...
  public Flux<ByteBuf> receive() {
    return received.transform(Operators.<ByteBuf, ByteBuf>lift((__, actual) ->
            new CoreSubscriber<>() {
              @Override
  ...
  public SocketAddress remoteAddress() {
    return new TestLocalSocketAddress("TestConnection");
  }
