...
public class MessageBuffer {
  ...
  private static final String UNIVERSAL_MESSAGE_BUFFER = "infra.cloud.serialize.format.buffer.MessageBufferU";
  private static final String BIGENDIAN_MESSAGE_BUFFER = "infra.cloud.serialize.format.buffer.MessageBufferBE";
  private static final String DEFAULT_MESSAGE_BUFFER = "infra.cloud.serialize.format.buffer.MessageBuffer";
   ...
   * Modifications to the new MessageBuffer will cause the byte array to be modified and vice versa.
   * <p>
